...
self.addEventListener('fetch',e=>{
  ...
  if(req.mode==='navigate'){
    e.respondWith(fetch(req).then(async r=>{
      ...
      html=html.replace('ui.css?v=9','ui.css?v=23').replace('app.js?v=9','app.js?v=23').replace('insights.js?v=9','insights.js?v=23');
      if(!html.includes('ux-fixes.js'))html=html.replace('</body>','<script src="ux-fixes.js?v=23"></script></body>');
      if(!html.includes('core-fixes.js'))html=html.replace('</body>','<script src="core-fixes.js?v=23"></script></body>');
